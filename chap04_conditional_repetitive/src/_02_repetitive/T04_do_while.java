...
public class T04_do_while {
	...
	public static void main(String[] args) {
		...
		int result = 0;
		do {
			System.out.println("1. for문 설명, 2. while문 설명, 3. do-while문 설명, 0.끝내려면 입력: ");
			result = sc.nextInt();
			switch(result) {
			case 1:
				System.out.println("반복의 조건식이 정해져 있을때 사용하면 좋음");
				break;
			case 2:
				System.out.println("특정 조건에 도달했을때 break를 사용하여 종료할때 유용");
				break;
			case 3:
